## Testing benchmark on GP_FairCD
#
# (x) python3 benchmark.py facebook --runs 10 --timeout 900 --sfairsc-k 13 15 --debug > ../logs/benchmark_log_facebook.txt
# (x) python3 benchmark.py deezer --runs 10 --timeout 900 --sfairsc-k 100 75 --debug > ../logs/benchmark_log_deezer.txt
# (x) python3 benchmark.py color-full_1000_r01_K2_c05 --runs 10 --timeout 900 --sfairsc-k 6 10 --debug > ../logs/benchmark_log_color-full_1000_r01_K2_c05.txt
# (x) python3 benchmark.py color-node_1000_r01_K2_c05 --runs 10 --timeout 900 --sfairsc-k 5 10 --debug > ../logs/benchmark_log_color-node_1000_r01_K2_c05.txt
## @TODO: add popnet here
